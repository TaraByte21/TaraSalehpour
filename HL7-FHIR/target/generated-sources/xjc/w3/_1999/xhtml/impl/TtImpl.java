...
public class TtImpl
    extends InlineImpl
    implements Serializable, ToString, Tt
{
    ...
    public TtImpl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public TtImpl withLang(String value) {
        setLang(value);
        return this;
    }

    public TtImpl withDir(String value) {
        setDir(value);
        return this;
    }

    public TtImpl withId(String value) {
        setId(value);
        return this;
    }

    public TtImpl withClazzs(String... values) {
        if (values!= null) {
    ...
    public TtImpl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public TtImpl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public TtImpl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public TtImpl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public TtImpl withContent(Collection<Object> values) {
        if (values!= null) {
