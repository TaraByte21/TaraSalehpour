...
public class PreContentImpl implements Serializable, ToString, PreContent
{
    ...
    public PreContentImpl withContent(Object... values) {
        if (values!= null) {
    ...
    public PreContentImpl withContent(Collection<Object> values) {
        if (values!= null) {
