...
public class KbdImpl
    extends InlineImpl
    implements Serializable, ToString, Kbd
{
    ...
    public KbdImpl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public KbdImpl withLang(String value) {
        setLang(value);
        return this;
    }

    public KbdImpl withDir(String value) {
        setDir(value);
        return this;
    }

    public KbdImpl withId(String value) {
        setId(value);
        return this;
    }

    public KbdImpl withClazzs(String... values) {
        if (values!= null) {
    ...
    public KbdImpl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public KbdImpl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public KbdImpl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public KbdImpl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public KbdImpl withContent(Collection<Object> values) {
        if (values!= null) {
