...
public class SubImpl
    extends InlineImpl
    implements Serializable, ToString, Sub
{
    ...
    public SubImpl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public SubImpl withLang(String value) {
        setLang(value);
        return this;
    }

    public SubImpl withDir(String value) {
        setDir(value);
        return this;
    }

    public SubImpl withId(String value) {
        setId(value);
        return this;
    }

    public SubImpl withClazzs(String... values) {
        if (values!= null) {
    ...
    public SubImpl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public SubImpl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public SubImpl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public SubImpl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public SubImpl withContent(Collection<Object> values) {
        if (values!= null) {
