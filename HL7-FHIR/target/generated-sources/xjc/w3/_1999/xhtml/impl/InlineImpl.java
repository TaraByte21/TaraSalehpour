...
public class InlineImpl implements Serializable, ToString, Inline
{
    ...
    public InlineImpl withContent(Object... values) {
        if (values!= null) {
    ...
    public InlineImpl withContent(Collection<Object> values) {
        if (values!= null) {
