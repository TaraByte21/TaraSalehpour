...
public class PreContent implements Serializable
{
    ...
    public PreContent withContent(Serializable... values) {
        if (values!= null) {
    ...
    public PreContent withContent(Collection<Serializable> values) {
        if (values!= null) {
