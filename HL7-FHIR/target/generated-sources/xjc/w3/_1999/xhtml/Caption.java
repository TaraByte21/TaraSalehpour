    ...
    implements Serializable
{
    ...
    public Caption withLanguage(String value) {
        setLanguage(value);
        return this;
    }
    ...
    public Caption withClazzs(String... values) {
        if (values!= null) {
    ...
    public Caption withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    @Override
    public Caption withContent(Serializable... values) {
        if (values!= null) {
    ...
    @Override
    public Caption withContent(Collection<Serializable> values) {
        if (values!= null) {
