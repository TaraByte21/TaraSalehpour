    ...
    implements Serializable
{
    ...
    protected List<edu.asu.bmi.cad.fhir_model_noDB.String> locations;
     ...
     * 
     */
    public List<edu.asu.bmi.cad.fhir_model_noDB.String> getLocations() {
        if (locations == null) {
            locations = new ArrayList<edu.asu.bmi.cad.fhir_model_noDB.String>();
        }
    ...
    public OperationOutcomeIssue withDetails(edu.asu.bmi.cad.fhir_model_noDB.String value) {
        setDetails(value);
        return this;
    }

    public OperationOutcomeIssue withLocations(edu.asu.bmi.cad.fhir_model_noDB.String... values) {
        if (values!= null) {
    ...
    public OperationOutcomeIssue withLocations(Collection<edu.asu.bmi.cad.fhir_model_noDB.String> values) {
        if (values!= null) {
