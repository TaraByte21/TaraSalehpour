    ...
    implements Serializable
{
    ...
    protected List<edu.asu.bmi.cad.fhir_model_noDB.String> searchIncludes;
     ...
     * 
     */
    public List<edu.asu.bmi.cad.fhir_model_noDB.String> getSearchIncludes() {
        if (searchIncludes == null) {
            searchIncludes = new ArrayList<edu.asu.bmi.cad.fhir_model_noDB.String>();
        }
    ...
    public ConformanceResource withSearchIncludes(edu.asu.bmi.cad.fhir_model_noDB.String... values) {
        if (values!= null) {
    ...
    public ConformanceResource withSearchIncludes(Collection<edu.asu.bmi.cad.fhir_model_noDB.String> values) {
        if (values!= null) {
