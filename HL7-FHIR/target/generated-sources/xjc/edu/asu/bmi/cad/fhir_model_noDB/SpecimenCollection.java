    ...
    implements Serializable
{
    ...
    protected List<edu.asu.bmi.cad.fhir_model_noDB.String> comments;
     ...
     * 
     */
    public List<edu.asu.bmi.cad.fhir_model_noDB.String> getComments() {
        if (comments == null) {
            comments = new ArrayList<edu.asu.bmi.cad.fhir_model_noDB.String>();
        }
    ...
    public SpecimenCollection withComments(edu.asu.bmi.cad.fhir_model_noDB.String... values) {
        if (values!= null) {
    ...
    public SpecimenCollection withComments(Collection<edu.asu.bmi.cad.fhir_model_noDB.String> values) {
        if (values!= null) {
