    ...
    implements Serializable
{
    ...
    protected List<edu.asu.bmi.cad.fhir_model_noDB.String> contexts;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<edu.asu.bmi.cad.fhir_model_noDB.String> getContexts() {
        if (contexts == null) {
            contexts = new ArrayList<edu.asu.bmi.cad.fhir_model_noDB.String>();
        }
    ...
    public ProfileExtensionDefn withDisplay(edu.asu.bmi.cad.fhir_model_noDB.String value) {
        setDisplay(value);
        return this;
    }
    ...
    public ProfileExtensionDefn withContexts(edu.asu.bmi.cad.fhir_model_noDB.String... values) {
        if (values!= null) {
    ...
    public ProfileExtensionDefn withContexts(Collection<edu.asu.bmi.cad.fhir_model_noDB.String> values) {
        if (values!= null) {
