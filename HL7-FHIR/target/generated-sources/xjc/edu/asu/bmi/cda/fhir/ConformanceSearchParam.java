...
<<<<<<< HEAD:HL7-FHIR/target/generated-sources/xjc/edu/asu/bmi/cda/fhir/ConformanceSearchParam.java
// Generated on: 2015.03.03 at 01:43:53 PM MST 
=======
// Generated on: 2015.03.01 at 11:08:02 PM MST 
>>>>>>> a3028c6592c87e58f7d16b2817f47aa4bc494a67:HL7-FHIR/target/generated-sources/xjc/edu/asu/bmi/cda/fhir/ConformanceSearchParam.java
//
    ...
    implements Serializable
{
    ...
    protected List<edu.asu.bmi.cda.fhir.String> chains;
     ...
     * 
     */
    public List<edu.asu.bmi.cda.fhir.String> getChains() {
        if (chains == null) {
            chains = new ArrayList<edu.asu.bmi.cda.fhir.String>();
        }
        return this.chains;
    }

    public ConformanceSearchParam withName(edu.asu.bmi.cda.fhir.String value) {
        setName(value);
        return this;
    }
    ...
    public ConformanceSearchParam withDocumentation(edu.asu.bmi.cda.fhir.String value) {
    ...
    public ConformanceSearchParam withChains(edu.asu.bmi.cda.fhir.String... values) {
        if (values!= null) {
    ...
    public ConformanceSearchParam withChains(Collection<edu.asu.bmi.cda.fhir.String> values) {
        if (values!= null) {
