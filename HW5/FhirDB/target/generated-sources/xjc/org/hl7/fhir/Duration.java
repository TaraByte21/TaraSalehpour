    ...
    implements Equals, HashCode
{
    ...
    @Override
    public Duration withValue(Decimal value) {
        setValue(value);
        return this;
    }

    @Override
    public Duration withComparator(QuantityCompararator value) {
        setComparator(value);
        return this;
    }

    @Override
    public Duration withUnits(org.hl7.fhir.String value) {
        setUnits(value);
        return this;
    }

    @Override
    public Duration withSystem(Uri value) {
        setSystem(value);
        return this;
    }

    @Override
    public Duration withCode(Code value) {
        setCode(value);
        return this;
    }

    @Override
    public Duration withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public Duration withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public Duration withExtension(List<Extension> extension) {
        setExtension(extension);
        return this;
    }

    @Override
    public Duration withId(java.lang.String value) {
        setId(value);
        return this;
    }
