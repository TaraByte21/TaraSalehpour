    ...
    implements Equals, HashCode
{
    ...
    @Override
    public UnitsOfTime withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public UnitsOfTime withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public UnitsOfTime withExtension(List<Extension> extension) {
