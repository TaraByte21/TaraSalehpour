    ...
    implements Equals, HashCode
{
    ...
    public MessageHeaderDestination withName(org.hl7.fhir.String value) {
        setName(value);
        return this;
    }
    ...
    @Override
    public MessageHeaderDestination withModifierExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public MessageHeaderDestination withModifierExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public MessageHeaderDestination withModifierExtension(List<Extension> modifierExtension) {
        setModifierExtension(modifierExtension);
        return this;
    }

    @Override
    public MessageHeaderDestination withExtension(Extension... values) {
        if (values!= null) {
            for (Extension value: values) {
    ...
    @Override
    public MessageHeaderDestination withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public MessageHeaderDestination withExtension(List<Extension> extension) {
