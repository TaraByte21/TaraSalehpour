...
@Entity(name = "ConditionRelationshipType")
@Table(name = "CONDITIONRELATIONSHIPTYPE")
    ...
    implements Equals, HashCode
{
    ...
    public ConditionRelationshipType withValue(ConditionRelationshipTypeList value) {
        setValue(value);
        return this;
    }

    @Override
    public ConditionRelationshipType withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public ConditionRelationshipType withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public ConditionRelationshipType withExtension(List<Extension> extension) {
        setExtension(extension);
        return this;
    }

    @Override
    public ConditionRelationshipType withId(java.lang.String value) {
        setId(value);
        return this;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ConditionRelationshipType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ConditionRelationshipType that = ((ConditionRelationshipType) object);
        {
