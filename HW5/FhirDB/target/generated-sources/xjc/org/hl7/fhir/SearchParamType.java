...
@Entity(name = "SearchParamType")
@Table(name = "SEARCHPARAMTYPE")
    ...
    implements Equals, HashCode
{
    ...
    @Override
    public SearchParamType withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public SearchParamType withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public SearchParamType withExtension(List<Extension> extension) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SearchParamType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final SearchParamType that = ((SearchParamType) object);
        {
