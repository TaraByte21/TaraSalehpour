...
@Entity(name = "ConstraintSeverity")
@Table(name = "CONSTRAINTSEVERITY")
    ...
    implements Equals, HashCode
{
    ...
    @Override
    public ConstraintSeverity withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public ConstraintSeverity withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public ConstraintSeverity withExtension(List<Extension> extension) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ConstraintSeverity)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ConstraintSeverity that = ((ConstraintSeverity) object);
        {
            ConstraintSeverityList lhsValue;
            lhsValue = this.getValue();
            ConstraintSeverityList rhsValue;
