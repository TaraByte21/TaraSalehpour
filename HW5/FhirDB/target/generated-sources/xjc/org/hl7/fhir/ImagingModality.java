...
@Entity(name = "ImagingModality")
@Table(name = "IMAGINGMODALITY")
    ...
    implements Equals, HashCode
{
    ...
    @Override
    public ImagingModality withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public ImagingModality withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public ImagingModality withExtension(List<Extension> extension) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ImagingModality)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ImagingModality that = ((ImagingModality) object);
        {
            ImagingModalityList lhsValue;
            lhsValue = this.getValue();
            ImagingModalityList rhsValue;
