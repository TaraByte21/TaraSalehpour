...
@Entity(name = "MedicationPrescriptionStatus")
@Table(name = "MEDICATIONPRESCRIPTIONSTATUS")
    ...
    implements Equals, HashCode
{
    ...
    @Override
    public MedicationPrescriptionStatus withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public MedicationPrescriptionStatus withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public MedicationPrescriptionStatus withExtension(List<Extension> extension) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MedicationPrescriptionStatus)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final MedicationPrescriptionStatus that = ((MedicationPrescriptionStatus) object);
        {
            MedicationPrescriptionStatusList lhsValue;
            lhsValue = this.getValue();
            MedicationPrescriptionStatusList rhsValue;
