    ...
    implements Equals, HashCode
{
    ...
    @Override
    public AlertStatus withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public AlertStatus withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public AlertStatus withExtension(List<Extension> extension) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AlertStatus)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final AlertStatus that = ((AlertStatus) object);
        {
            AlertStatusList lhsValue;
            lhsValue = this.getValue();
            AlertStatusList rhsValue;
