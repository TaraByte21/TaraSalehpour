    ...
    implements Equals, HashCode
{
    ...
    public ConformanceOperation withDocumentation(org.hl7.fhir.String value) {
        setDocumentation(value);
        return this;
    }

    @Override
    public ConformanceOperation withModifierExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public ConformanceOperation withModifierExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public ConformanceOperation withModifierExtension(List<Extension> modifierExtension) {
        setModifierExtension(modifierExtension);
        return this;
    }

    @Override
    public ConformanceOperation withExtension(Extension... values) {
        if (values!= null) {
            for (Extension value: values) {
    ...
    @Override
    public ConformanceOperation withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public ConformanceOperation withExtension(List<Extension> extension) {
