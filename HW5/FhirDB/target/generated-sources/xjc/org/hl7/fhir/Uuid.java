    ...
    implements Equals, HashCode
{
    ...
    @Override
    public Uuid withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public Uuid withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public Uuid withExtension(List<Extension> extension) {
