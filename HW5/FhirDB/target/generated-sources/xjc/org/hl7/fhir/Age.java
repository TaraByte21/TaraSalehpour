    ...
    implements Equals, HashCode
{
    ...
    @Override
    public Age withUnits(org.hl7.fhir.String value) {
        setUnits(value);
        return this;
    }
    ...
    @Override
    public Age withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public Age withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public Age withExtension(List<Extension> extension) {
