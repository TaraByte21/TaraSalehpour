...
@Entity(name = "CarePlanActivityCategory")
@Table(name = "CAREPLANACTIVITYCATEGORY")
    ...
    implements Equals, HashCode
{
    ...
    @Override
    public CarePlanActivityCategory withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public CarePlanActivityCategory withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public CarePlanActivityCategory withExtension(List<Extension> extension) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CarePlanActivityCategory)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CarePlanActivityCategory that = ((CarePlanActivityCategory) object);
        {
            CarePlanActivityCategoryList lhsValue;
            lhsValue = this.getValue();
            CarePlanActivityCategoryList rhsValue;
