    ...
    implements Equals, HashCode
{
    ...
    @Override
    public Distance withUnits(org.hl7.fhir.String value) {
        setUnits(value);
        return this;
    }
    ...
    @Override
    public Distance withExtension(Extension... values) {
        if (values!= null) {
    ...
    @Override
    public Distance withExtension(Collection<Extension> values) {
        if (values!= null) {
    ...
    @Override
    public Distance withExtension(List<Extension> extension) {
