...
public class Ul implements Serializable
{
    ...
    public Ul withLis(Collection<Li> values) {
        if (values!= null) {
    ...
    public Ul withId(String value) {
        setId(value);
        return this;
    }

    public Ul withClazzs(String... values) {
        if (values!= null) {
    ...
    public Ul withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public Ul withStyle(String value) {
        setStyle(value);
        return this;
    }

    public Ul withTitle(String value) {
        setTitle(value);
        return this;
    }

    public Ul withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public Ul withLang(String value) {
        setLang(value);
        return this;
    }

    public Ul withDir(String value) {
        setDir(value);
        return this;
    }
