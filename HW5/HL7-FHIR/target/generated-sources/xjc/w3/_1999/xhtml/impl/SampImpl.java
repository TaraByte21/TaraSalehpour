...
public class SampImpl
    extends InlineImpl
    implements Serializable, ToString, Samp
{
    ...
    public SampImpl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public SampImpl withLang(String value) {
        setLang(value);
        return this;
    }

    public SampImpl withDir(String value) {
        setDir(value);
        return this;
    }

    public SampImpl withId(String value) {
        setId(value);
        return this;
    }

    public SampImpl withClazzs(String... values) {
        if (values!= null) {
    ...
    public SampImpl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public SampImpl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public SampImpl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public SampImpl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public SampImpl withContent(Collection<Object> values) {
        if (values!= null) {
