...
public class H6Impl
    extends InlineImpl
    implements Serializable, ToString, H6
{
    ...
    public H6Impl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public H6Impl withLang(String value) {
        setLang(value);
        return this;
    }

    public H6Impl withDir(String value) {
        setDir(value);
        return this;
    }

    public H6Impl withId(String value) {
        setId(value);
        return this;
    }

    public H6Impl withClazzs(String... values) {
        if (values!= null) {
    ...
    public H6Impl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public H6Impl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public H6Impl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public H6Impl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public H6Impl withContent(Collection<Object> values) {
        if (values!= null) {
