...
public class DfnImpl
    extends InlineImpl
    implements Serializable, ToString, Dfn
{
    ...
    public DfnImpl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public DfnImpl withLang(String value) {
        setLang(value);
        return this;
    }

    public DfnImpl withDir(String value) {
        setDir(value);
        return this;
    }

    public DfnImpl withId(String value) {
        setId(value);
        return this;
    }

    public DfnImpl withClazzs(String... values) {
        if (values!= null) {
    ...
    public DfnImpl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public DfnImpl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public DfnImpl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public DfnImpl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public DfnImpl withContent(Collection<Object> values) {
        if (values!= null) {
