...
public class TbodyImpl
    implements Serializable, ToString, Tbody
{
    ...
    public TbodyImpl withTrs(Tr... values) {
        if (values!= null) {
            for (Tr value: values) {
                getTrs().add(value);
            }
    ...
    public TbodyImpl withTrs(Collection<Tr> values) {
        if (values!= null) {
    ...
    public TbodyImpl withValign(String value) {
        setValign(value);
        return this;
    }

    public TbodyImpl withAlign(String value) {
        setAlign(value);
        return this;
    }

    public TbodyImpl withChar(String value) {
        setChar(value);
        return this;
    }

    public TbodyImpl withCharoff(String value) {
        setCharoff(value);
        return this;
    }

    public TbodyImpl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public TbodyImpl withLang(String value) {
        setLang(value);
        return this;
    }

    public TbodyImpl withDir(String value) {
        setDir(value);
        return this;
    }

    public TbodyImpl withId(String value) {
        setId(value);
        return this;
    }

    public TbodyImpl withClazzs(String... values) {
        if (values!= null) {
    ...
    public TbodyImpl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public TbodyImpl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public TbodyImpl withTitle(String value) {
        setTitle(value);
        return this;
    }
