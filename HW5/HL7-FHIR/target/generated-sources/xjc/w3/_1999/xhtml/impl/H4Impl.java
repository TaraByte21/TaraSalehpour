...
public class H4Impl
    extends InlineImpl
    implements Serializable, ToString, H4
{
    ...
    public H4Impl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public H4Impl withLang(String value) {
        setLang(value);
        return this;
    }

    public H4Impl withDir(String value) {
        setDir(value);
        return this;
    }

    public H4Impl withId(String value) {
        setId(value);
        return this;
    }

    public H4Impl withClazzs(String... values) {
        if (values!= null) {
    ...
    public H4Impl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public H4Impl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public H4Impl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public H4Impl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public H4Impl withContent(Collection<Object> values) {
        if (values!= null) {
