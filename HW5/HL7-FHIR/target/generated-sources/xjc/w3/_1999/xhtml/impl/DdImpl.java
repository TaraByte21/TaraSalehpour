...
public class DdImpl
    extends FlowImpl
    implements Serializable, ToString, Dd
{
    ...
    public DdImpl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public DdImpl withLang(String value) {
        setLang(value);
        return this;
    }

    public DdImpl withDir(String value) {
        setDir(value);
        return this;
    }

    public DdImpl withId(String value) {
        setId(value);
        return this;
    }

    public DdImpl withClazzs(String... values) {
        if (values!= null) {
    ...
    public DdImpl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public DdImpl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public DdImpl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public DdImpl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public DdImpl withContent(Collection<Object> values) {
        if (values!= null) {
