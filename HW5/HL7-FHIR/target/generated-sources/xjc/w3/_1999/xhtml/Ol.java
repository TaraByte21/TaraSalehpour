...
public class Ol implements Serializable
{
    ...
    public Ol withLis(Collection<Li> values) {
        if (values!= null) {
    ...
    public Ol withId(String value) {
        setId(value);
        return this;
    }

    public Ol withClazzs(String... values) {
        if (values!= null) {
    ...
    public Ol withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public Ol withStyle(String value) {
        setStyle(value);
        return this;
    }

    public Ol withTitle(String value) {
        setTitle(value);
        return this;
    }

    public Ol withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public Ol withLang(String value) {
        setLang(value);
        return this;
    }

    public Ol withDir(String value) {
        setDir(value);
        return this;
    }
