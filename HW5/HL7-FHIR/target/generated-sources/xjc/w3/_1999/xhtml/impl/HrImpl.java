...
public class HrImpl implements Serializable, ToString, Hr
{
    ...
    public HrImpl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public HrImpl withLang(String value) {
        setLang(value);
        return this;
    }

    public HrImpl withDir(String value) {
        setDir(value);
        return this;
    }

    public HrImpl withId(String value) {
        setId(value);
        return this;
    }

    public HrImpl withClazzs(String... values) {
        if (values!= null) {
    ...
    public HrImpl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public HrImpl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public HrImpl withTitle(String value) {
        setTitle(value);
        return this;
    }
