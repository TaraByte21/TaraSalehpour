...
public class H3Impl
    extends InlineImpl
    implements Serializable, ToString, H3
{
    ...
    public H3Impl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public H3Impl withLang(String value) {
        setLang(value);
        return this;
    }

    public H3Impl withDir(String value) {
        setDir(value);
        return this;
    }

    public H3Impl withId(String value) {
        setId(value);
        return this;
    }

    public H3Impl withClazzs(String... values) {
        if (values!= null) {
    ...
    public H3Impl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public H3Impl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public H3Impl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public H3Impl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public H3Impl withContent(Collection<Object> values) {
        if (values!= null) {
