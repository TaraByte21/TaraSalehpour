...
public class EmImpl
    extends InlineImpl
    implements Serializable, ToString, Em
{
    ...
    public EmImpl withLanguage(String value) {
        setLanguage(value);
        return this;
    }

    public EmImpl withLang(String value) {
        setLang(value);
        return this;
    }

    public EmImpl withDir(String value) {
        setDir(value);
        return this;
    }

    public EmImpl withId(String value) {
        setId(value);
        return this;
    }

    public EmImpl withClazzs(String... values) {
        if (values!= null) {
    ...
    public EmImpl withClazzs(Collection<String> values) {
        if (values!= null) {
    ...
    public EmImpl withStyle(String value) {
        setStyle(value);
        return this;
    }

    public EmImpl withTitle(String value) {
        setTitle(value);
        return this;
    }

    @Override
    public EmImpl withContent(Object... values) {
        if (values!= null) {
    ...
    @Override
    public EmImpl withContent(Collection<Object> values) {
        if (values!= null) {
